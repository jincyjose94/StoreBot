...
**
*****************************************************************************/
void I2C0_IRQHandler(void) //deals with master mode only
{
  uint8_t StatValue;
  ...
  switch ( StatValue )
  {
	case 0x08:		//master transmitter	/* A Start condition is issued. */
	WrIndex0 = 0;
	LPC_I2C0->I2DAT = I2CMasterBuffer[0][WrIndex0++];
	LPC_I2C0->I2CONCLR = (I2CONCLR_SIC | I2CONCLR_STAC); //i2c interrupt clear and start flag clear
	break;
...
void I2C1_IRQHandler(void)
{
  ...
  switch ( StatValue )
  {
	...
	case 0x10:
	//WrIndex1 = 0;/* A repeated started is issued */
	RdIndex1 = 0;
	/* Send SLA with R bit set, */
	LPC_I2C1->I2DAT = I2CMasterBuffer[1][WrIndex1++];
	LPC_I2C1->I2CONCLR = (I2CONCLR_SIC | I2CONCLR_STAC);
