...
extern uint8_t  EX_LSM303_READ(uint8_t adres);
extern uint8_t  EX_LSM303_WRITE(uint8_t adres, uint8_t veri);
...
//extern volatile uint32_t I2CCount[I2C_PORT_NUM];
//extern volatile uint32_t I2CCmd, I2CMasterState[I2C_PORT_NUM];
